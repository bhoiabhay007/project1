...
int main() {
    ...
    while (true) {
        ...
        switch (choice) {
        case 1:
            account = new SavingsAccount(101, "Abhay", 15000, 5.5);
            cout << "Savings Account Created!\n";
            break;

        case 2:
            account = new CheckingAccount(202, "harshit", 10000, 5000);
            cout << "Checking Account Created!\n";
            break;

        case 3:
            account = new FixedDepositAccount(303, "rohit", 50000, 12, 7.2);
