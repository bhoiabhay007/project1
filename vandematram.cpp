...
int main() {
  ...
  if(choiceno==2){
         trainrecords t[5];
        t[0].setdetail(1,"jesalmer express","ahmdabad","ranuja","08:10:00 pm");
         t[1].setdetail(2,"sabarmatiti express","modasa","Ahmedabad","09:25:10 pm");
          t[2].setdetail(3,"mumbai padra","ahmdabad","mumbai","11:15:00 pm");
  ...
  if(choiceno==3){
        ...
        flag=0;
              trainrecords t[5]={
        trainrecords(1,"jesalmer express","ahmdabad","ranuja","08:10:00 pm"),
        trainrecords(2,"sabarmatiti express","modasa","Ahmedabad","09:25:10 pm"),
        trainrecords(3,"mumbai padra","ahmdabad","mumbaio.","11:15:00 pm"),
        trainrecords(4,"kanpur express","modasa","kanpur","12:30:00 pm"),
        trainrecords(5,"himachal express","modasa","manali","07:45:00 am")
              };
